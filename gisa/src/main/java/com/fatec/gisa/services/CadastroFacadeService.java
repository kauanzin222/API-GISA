...
public class CadastroFacadeService {
    ...
    @Transactional
    public Especialista cadastrarEspecialistaComUsuario(EspecialistaCadastroRequestDTO dto, UsuarioRequestDTO usuarioDto) {
    ...
    @Transactional
    public EspecialistaPJ cadastrarEspecialistaPJComUsuario(EspecialistaPJCadastroRequestDTO dto, UsuarioRequestDTO usuarioDto) {
